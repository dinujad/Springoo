        ...
        <div class="footer-col brand-col">
            <div class="footer-brand">
                <div class="brand-icon">
                    <img src="{{ asset('images/logo.png') }}" alt="Springoo Logo" style="filter: brightness(0) invert(1);">
                </div>
            </div>
            <p class="brand-tagline">
                Luxury jewelry inspired by the eternal beauty of nature. Crafted with care, worn with love.
            </p>
            <!-- Social icons restored with user links -->
            <div class="social-icons" style="margin-top: 20px;">
                <a href="https://www.facebook.com/springoocmb/" target="_blank" class="social-icon">
                ...
                <a href="https://www.instagram.com/springoo.lk/" target="_blank" class="social-icon">
